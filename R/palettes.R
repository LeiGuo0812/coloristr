...
discrete_palettes <- list(
  ...
  xhs.ocean = c("#BFDFD2", "#51999F", "#4198AC", "#7BC0CD", "#DBCB92", "#ECB66C", "#EA9E58", "#ED8D5A"),
  xhs.dawnbreaking = c("#1E90FF", "#3E9BFF", "#5FA6FF", "#80B1FF", "#A1BCFF", "#C2C7FF", "#E3D2FF", "#FFDDAA", "#FFE877", "#FFD700"),
  xhs.metal = c("#5C6572", "#4095C1", "#838790", "#E2673A", "#B5A5A3", "#B9CFDB", "#D0D5D9", "#F5AD92"),
